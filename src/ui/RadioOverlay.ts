...
export function ensureRadioOverlay(): RadioOverlayHandle {
  ...
  return {
    show(){ const el = document.getElementById('radio-overlay'); if (el) el.style.display = 'block'; },
...
function installStyles() {
  ...
  #radio-overlay .ro-shell{display:flex;align-items:center;gap:6px;border:1px solid rgba(0,255,255,0.35);background:rgba(0,25,38,0.32);backdrop-filter:blur(4px);padding:4px 8px;border-radius:10px;width:520px;height:28px}
  ...
  #radio-overlay .ro-title{font-size:12px;color:#9adfff;width:280px;white-space:nowrap;overflow:hidden;position:relative}
  #radio-overlay #ro-volume{appearance:none;width:120px;height:4px;background:rgba(0,255,255,0.22);border-radius:3px;outline:none;margin-left:6px}
  ...
  @media (max-width: 920px){ #radio-overlay{right: 12px; top: 48px} }
  `;
