...
export const CHARACTERS: CharacterData[] = [
  ...
  defaultWeapon: WeaponType.TACHYON_SPEAR,
    ...
    shape: 'square',
    color: '#4169E1',
  weaponTypes: [WeaponType.WARRIOR_CANNON, WeaponType.TRI_SHOT, WeaponType.PLASMA, WeaponType.BEAM, WeaponType.TACHYON_SPEAR, WeaponType.SINGULARITY_SPEAR],
  ...
  lore: 'They hear the city like a choir: fan hums, fiber whispers, hearts in syncopation. Once they wrote code to move markets; now they draw glyphs that retask fate. Orbs orbit like patient moons, beams etch corrections into the night. When they finish a cast, the world is a little more kind.',
    ...
    defaultWeapon: WeaponType.DATA_SIGIL,
    stats: {
      hp: 95,
      maxHp: 95,
      speed: 8.4,
    ...
    shape: 'triangle',
    color: '#FF00FF',
  weaponTypes: [WeaponType.DATA_SIGIL, WeaponType.SORCERER_ORB, WeaponType.BEAM, WeaponType.PLASMA, WeaponType.TRI_SHOT],
  ...
  defaultWeapon: WeaponType.VOID_SNIPER,
    ...
    shape: 'triangle',
    color: '#2F4F4F',
  weaponTypes: [WeaponType.VOID_SNIPER, WeaponType.SHADOW_DAGGER, WeaponType.RICOCHET, WeaponType.TRI_SHOT, WeaponType.BEAM],
